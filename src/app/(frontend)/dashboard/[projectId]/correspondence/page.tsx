                    ...
                    <Group justify="space-between">
                      <Group gap="md">
                        ...
                        <Box>
                          ...
                          <Text size="xs" c="dimmed" ff="var(--font-body)">05 Feb 2026 // 09:12 // REF: {projectIdFormatted}-MEMO-01</Text>
                        </Box>
                      </Group>
