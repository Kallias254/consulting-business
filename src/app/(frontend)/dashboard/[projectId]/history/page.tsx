          ...
          <Box style={{ gridColumn: 'span 2' }}>
            <Stack gap="md">
              <Group justify="space-between" mb={4}>
                <Text size="10px" fw={800} c="#62666B" style={{ letterSpacing: '2px' }}>
                  MODULAR_REVISION_LEDGER
                </Text>
                <Tooltip label="All revisions are cryptographically signed" radius={0}>
                  <Group gap={6}>
                    <IconFingerprint size={14} color="var(--mantine-color-sage-7)" />
                    <Text size="10px" fw={800} c="sage.8" style={{ letterSpacing: '1px' }}>
                      SOVEREIGN_PROOF_ACTIVE
                    </Text>
                  </Group>
                </Tooltip>
              </Group>
                      ...
                      <Group justify="space-between">
                        ...
                        <Badge
                          ...
                          styles={{
                            root: {
                              border:
                                unit.status === 'validated' ? 'none' : '1.5px solid currentColor',
                              fontWeight: 800,
                              textTransform: 'uppercase',
                              letterSpacing: '1px',
                            },
                            ...
                            <Table.Tr key={rev.id}>
                              ...
                              <Table.Td>
                                <Stack gap={2}>
                                  ...
                                  <Text size="10px" c="#62666B" ff="mono">
                                    SHA: {rev.sha}
                                  </Text>
                                </Stack>
                              </Table.Td>
                              <Table.Td>
                                <Text size="sm" fw={500} c="deep-green.9">
                                  {rev.date}
                                </Text>
                              </Table.Td>
                              <Table.Td>
                                <Badge
                                  ...
                                  variant="dot"
                                  color={
                                    rev.status === 'validated' || rev.status === 'active'
                                      ? 'sage.7'
                                      : 'gray.6'
                                  }
                                  radius={0}
          ...
          <Stack gap="xl">
            <Paper withBorder radius={0} p={40} bg="white" style={{ borderColor: '#E0DBCC' }}>
              <Title
                ...
                ff="var(--font-display)"
                mb="xl"
                style={{ textTransform: 'uppercase', letterSpacing: '1.5px', color: '#0A140F' }}
              >
                <IconHistory
                  size={20}
                  style={{
              ...
              <Timeline active={3} bulletSize={24} lineWidth={1.5} color="burnished-gold.7">
                <Timeline.Item
                  ...
                  title={
                    <Text size="xs" fw={800} c="deep-green.9" style={{ letterSpacing: '1px' }}>
                      PROJECT_INGESTION
                    </Text>
                  }
                >
                  <Text size="sm" c="#62666B" mt={4} style={{ lineHeight: 1.4 }}>
                    Initial Manuscript Audio & Word-to-Typst mapping complete.
                  </Text>
                  <Text size="10px" mt={6} fw={700} c="#62666B">
                    01 FEB 2026
                  </Text>
                </Timeline.Item>
                ...
                <Timeline.Item
                  ...
                  title={
                    <Text size="xs" fw={800} c="deep-green.9" style={{ letterSpacing: '1px' }}>
                      INTRODUCTION_AND_SCOPE_VALIDATED
                    </Text>
                  }
                >
                  <Text size="sm" c="#62666B" mt={4} style={{ lineHeight: 1.4 }}>
                    Final institutional approval for Unit 01 (Introduction & Scope).
                  </Text>
                  <Text size="10px" mt={6} fw={700} c="#62666B">
                    15 FEB 2026
                  </Text>
                ...
                <Timeline.Item
                  bullet={<IconShieldCheck size={14} />}
                  title={
                    <Text size="xs" fw={800} c="deep-green.9" style={{ letterSpacing: '1px' }}>
                      METHODOLOGY_AUDIT
                    </Text>
                ...
                >
                  <Text size="sm" c="#62666B" mt={4} style={{ lineHeight: 1.4 }}>
                    Chapter 1-3 statistical validation and BibTeX integrity pass.
                  </Text>
                  <Text size="10px" mt={6} fw={700} c="#62666B">
                    14 FEB 2026
                  </Text>
                ...
                <Timeline.Item
                  ...
                  title={
                    <Text size="xs" fw={800} c="burnished-gold.8" style={{ letterSpacing: '1px' }}>
                      SCHOLAR_REVIEW_ACTIVE
                    </Text>
                  }
                >
                  <Text size="sm" c="deep-green.9" mt={4} fw={500}>
                    Current Unit: Literature Review undergoing final executive proofing.
                  </Text>
                  <Text
                    size="10px"
                    mt={6}
                ...
                <Timeline.Item
                  bullet={<IconFileCheck size={14} />}
                  title={
                    <Text size="xs" fw={800} c="gray.5" style={{ letterSpacing: '1px' }}>
                      FINAL_LIAISON_HANDOFF
                    </Text>
                  }
                >
                  <Text size="sm" c="gray.5" mt={4}>
                    Promotion to Asset Vault & Publisher Submission.
                  </Text>
                  <Text size="10px" mt={6} fw={700} c="gray.4">
                    EST: 15 MAR 2026
                  </Text>
                </Timeline.Item>
              </Timeline>
              ...
              >
                <Stack gap={2} align="center">
                  ...
                  <Text ff="var(--font-display)" size="lg" fw={800} c="deep-green.9">
                    PRINCIPAL MICAH S.
                  </Text>
                </Stack>
              </Group>
