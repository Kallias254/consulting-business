...
export default function EditorialClearancePage() {
          ...
          <Group justify="space-between" align="flex-end" wrap="wrap">
            <Box>
              <Title order={2} ff="var(--font-display)" size="2.5rem" style={{ textTransform: 'uppercase' }}>
                Editorial <Text component="span" inherit c="burnished-gold.7">Clearance</Text>
              </Title>
              <Text c="dimmed" size="sm" ff="var(--font-body)" mt={4}>
                Executive Correspondence Authorization // Technical Draft Review // Principal Clearance Loop
              </Text>
            </Box>
            <Button 
              color="burnished-gold" 
