      ...
      <Stack gap={40}>
          ...
          <Group justify="space-between" align="flex-end" wrap="wrap">
            <Box>
              <Title order={2} ff="var(--font-display)" size="2.5rem" style={{ textTransform: 'uppercase' }}>
                Executive <Text component="span" inherit c="burnished-gold.7">Pulse</Text> Desk
              </Title>
        ...
        <SimpleGrid cols={{ base: 1, sm: 2, md: 3 }} spacing="xl">
          <Paper withBorder p="xl" radius={0} bg="#0A0B0C" style={{ borderColor: '#2A2D31' }}>
            ...
            <Text size="7px" ff="var(--font-body)" c="dimmed">UNTIL NEXT SCHEDULED RELEASE</Text>
          </Paper>
              ...
              <Table.Tbody>
                {pulseDrafts.map((pulse) => (
                  <Table.Tr key={pulse.id} style={{ borderBottom: '1px solid #2A2D31' }}>
                    ...
                    <Table.Td>
                      <Badge variant="outline" color="gray.6">{pulse.phase.toUpperCase()}</Badge>
                    </Table.Td>
                    <Table.Td>
