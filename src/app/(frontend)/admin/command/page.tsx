      ...
      >
            ...
            <Group gap="md">
              ...
              <Box>
                ...
                <Text size="xs" c="dimmed" visibleFrom="xs">
                  Author: {selectedProject?.author} {' // '} MS-ID:{' '}
        ...
        <SimpleGrid cols={{ base: 1, lg: 2 }} spacing={0}>
          ...
          <Box
            ...
            bg="black"
            style={{
              borderRight: isMobile ? 'none' : '1px solid #2A2D31',
              borderBottom: isMobile ? '1px solid #2A2D31' : 'none',
              ...
              <Stack gap={{ base: 30, sm: 60 }} style={{ position: 'relative', zIndex: 2 }}>
                ...
                <Box>
                  ...
                  <Text size="xs" c="dark" style={{ lineHeight: 2, textAlign: 'justify' }}>
                    This research investigates the intersection of digital space architecture and
                    cognitive development in adolescent populations. By leveraging our proprietary
                    WASM-rendering engine, we have achieved a 99% accuracy rate in typesetting
                    complex methodological formulas that traditional Word-based processors fail to
                    align...
                  </Text>
                </Box>

                <Box p="xl" style={{ border: '1px solid #eee' }}>
                  <Text size="7px" c="dimmed" mb="xs">
                    FIGURE 1.1: SOCIO-TECHNICAL_FLUX_MAP
                  </Text>
                  <Box
                    h={120}
                    bg="gray.0"
          ...
          <Stack
            ...
            style={{ height: isMobile ? 'auto' : '75vh', overflowY: 'auto' }}
          >
            <Stack gap="xl">
              <Box>
                <Group gap="xs" mb="md">
                ...
                <Group gap="md">
                  ...
                  <Box>
                    <Text size="7px" c="dimmed">
                      CRYPTOGRAPHIC_AUTH_ID
                    </Text>
                    <Text ff="var(--font-body)" size="xs" c="parchment" fw={700}>
                      SECURE_HASH: 0x7E3B...C442
                    </Text>
                  </Box>
                </Group>
              </Paper>
                ...
                {[
                  {
                    ...
                    project: 'Social Dynamics in Digital Spaces',
                    readiness: 94,
                    wait: '14h',
                    avatar: 'EC',
                  },
                  {
                    author: 'Dr. Marcus Ross',
                    project: 'Quantum Computing Fundamentals',
                    readiness: 88,
                    wait: '1.5d',
                    avatar: 'MR',
                  },
                  ...
                  },
                  {
                    ...
                    project: 'Biological Signaling Pathways',
                    readiness: 82,
                    wait: '2.4d',
                    avatar: 'JW',
                  },
                  ...
                  <Table.Tr key={i} style={{ borderBottom: '1px solid #2A2D31' }}>
                    ...
                    <Table.Td>
                      <Group gap="sm">
                          ...
                          sections={[
                            {
                              ...
                              color: item.readiness > 90 ? 'sage' : 'burnished-gold',
                            },
                          ]}
                          label={
                            <Text size="7px" ta="center" ff="var(--font-body)" c="#E1E1E1">
                              {item.readiness}%
                            </Text>
                          }
                        />
                        <Text
                          size="xs"
                          c={item.readiness > 90 ? 'sage' : 'burnished-gold'}
                          ff="var(--font-body)"
                        >
                          READY
                        </Text>
                    ...
                    <Table.Td>
                      <Group gap="xs">
                        ...
                        <Text size="xs" ff="var(--font-body)" c="#E1E1E1">
                          {item.wait}
                        </Text>
                      </Group>
                    </Table.Td>
                    <Table.Td>
                      <Group gap="xs">
                        ...
                        <Popover
                          ...
                          radius={0}
                          styles={{
                            dropdown: { background: '#0A0B0C', border: '1px solid #2A2D31' },
                          }}
                        >
                          <Popover.Target>
        ...
        <SimpleGrid cols={{ base: 1, sm: 2, md: 3 }} spacing="xl">
          <Paper withBorder p="xl" radius={0} bg="#0A0B0C" style={{ borderColor: '#2A2D31' }}>
            <Group justify="space-between" mb="md">
              <Text ff="var(--font-body)" size="xs" c="burnished-gold">
                SYSTEM_INTEGRITY
              </Text>
              <IconFileCertificate size={16} color="var(--mantine-color-burnished-gold-7)" />
            </Group>
            <Text size="xs" c="dimmed" mb="lg">
              All manuscripts currently in queue have passed the automated Prismer.AI validation
              suite.
            </Text>
          ...
          <Paper withBorder p="xl" radius={0} bg="#0A0B0C" style={{ borderColor: '#2A2D31' }}>
            ...
            <Text size="xs" c="dimmed" mb="lg">
              Primary liaison active. Response times are within the established white-glove window.
            </Text>
          ...
          <Paper withBorder p="xl" radius={0} bg="#0A0B0C" style={{ borderColor: '#2A2D31' }}>
            ...
            <Text size="xs" c="dimmed" mb="lg">
              Projected completions for Q1 are tracking at 112% of baseline targets.
            </Text>
