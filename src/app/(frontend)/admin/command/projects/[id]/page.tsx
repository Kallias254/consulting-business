  ...
  return (
    <Container size="xl" py="xl">
      ...
      >
        <Box p="xl" bg="#0A0B0C" style={{ borderBottom: '1px solid #2A2D31' }}>
          <Group justify="space-between">
            <Box>
              <Text size="9px" c="burnished-gold" mb={4} style={{ letterSpacing: '2px' }}>
            ...
            <ActionIcon variant="subtle" color="gray" onClick={closeViewMemo}>
              <IconX size={20} />
            </ActionIcon>
          </Group>
        </Box>
        <Box p={40} bg="black" style={{ position: 'relative', overflow: 'hidden' }}>
          <Text
            ...
            c="white"
            opacity={0.02}
            style={{ transform: 'rotate(-20deg)', pointerEvents: 'none' }}
          >
            PRINCIPIA_ARCHIVE
          </Text>
          <Paper p="xl" radius={0} bg="white" style={{ position: 'relative', zIndex: 2 }}>
            <Stack gap="lg">
              <Box style={{ borderBottom: '1px solid #eee', paddingBottom: '20px' }}>
                ...
                <Text size="xs" fw={700} c="dark">
                  TO: {selectedMemo?.target}
                </Text>
                <Text size="sm" fw={800} mt="md" c="black">
              ...
              <Text
                size="xs"
                c="dark"
                style={{ lineHeight: 1.8, whiteSpace: 'pre-wrap', fontFamily: 'serif' }}
              >
        ...
        <Box p="md" bg="#0A0B0C" style={{ borderTop: '1px solid #2A2D31' }}>
          <Group justify="space-between">
            <Text size="9px" c="dimmed">
              DIGITAL_FINGERPRINT: 0x8F...2A1B
            </Text>
            <Badge size="xs" color="sage" variant="outline" radius={0}>
              IMMUTABLE_RECORD
            </Badge>
          </Group>
        </Box>
      ...
      >
        <Stack gap="md" p="xl">
          <Box>
            ...
            <Badge variant="outline" color="burnished-gold" radius={0}>
      ...
      >
        <Stack gap="md" p="xl">
          <Box>
            <Text size="9px" c="burnished-gold" mb={4}>
              PROJECT_CONTEXT
            </Text>
      ...
      <Stack gap={40}>
        ...
        <SimpleGrid cols={{ base: 1, sm: 2, lg: 4 }} spacing="md">
          <Paper withBorder p="md" radius={0} bg="#0A0B0C" style={{ borderColor: '#2A2D31' }}>
            <Text size="9px" c="burnished-gold" mb={4} style={{ letterSpacing: '1px' }}>
              CLIENT_ENTITY
            </Text>
            <Text ff="var(--font-display)" size="md" c="#E1E1E1">
              {project.client}
            </Text>
          </Paper>
          <Paper withBorder p="md" radius={0} bg="#0A0B0C" style={{ borderColor: '#2A2D31' }}>
          ...
          <Paper withBorder p="md" radius={0} bg="#0A0B0C" style={{ borderColor: '#2A2D31' }}>
            <Group justify="space-between" align="center" wrap="nowrap">
              <Box>
                <Text size="9px" c="sage" mb={2} style={{ letterSpacing: '1px' }}>
                  READINESS
                </Text>
                <Text ff="var(--font-display)" size="lg" c="#E1E1E1">
                  {project.readiness}%
                </Text>
              </Box>
              <RingProgress
        ...
        <Stack gap="xl">
          ...
          <Paper
            ...
            p={0}
            bg="transparent"
            style={{ borderColor: '#2A2D31', overflow: 'hidden' }}
          >
            <Box p="xl" bg="#0A0B0C" style={{ borderBottom: '1px solid #2A2D31' }}>
              <Group justify="space-between">
                <Title
            ...
            >
              <Tabs.List style={{ borderBottom: '1px solid #2A2D31' }}>
                <Tabs.Tab value="milestones" leftSection={<IconHistory size={14} />}>
                  Success Trail
                </Tabs.Tab>
                <Tabs.Tab value="comms" leftSection={<IconMessageCircle size={14} />}>
                  Liaison Record
                </Tabs.Tab>
                <Tabs.Tab value="technical" leftSection={<IconTerminal2 size={14} />}>
                  Internal Log
                </Tabs.Tab>
              </Tabs.List>
                ...
                <Stack gap="xl">
                  <Box>
                    ...
                    >
                      <Timeline.Item
                        ...
                        title={
                          <Text size="sm" c="#E1E1E1" fw={700}>
                            Project Inception
                          </Text>
                        }
                      >
                        <Text size="xs" c="dimmed">
                          Diagnostic Audit Passed // 01 Feb 2026
                        </Text>
                      </Timeline.Item>
                      <Timeline.Item
                        bullet={
                      ...
                      >
                        <Text size="xs" c="dimmed">
                          WASM Environment Initialized // 02 Feb 2026
                        </Text>
                      </Timeline.Item>
                      <Timeline.Item
                        bullet={
                      ...
                      >
                        <Text size="xs" c="dimmed">
                          BibTeX & Figure Integrity Verified // 05 Feb 2026
                        </Text>
                      </Timeline.Item>
                      <Timeline.Item
                        bullet={
                          <IconClock size={18} stroke={1.5} color="var(--mantine-color-sage-7)" />
                        }
                        title={
                          <Text size="sm" c="sage" fw={700}>
                            Executive Clearance
                          </Text>
                        }
                      >
                      ...
                      <Timeline.Item
                        bullet={
                          <IconSend size={18} stroke={1.5} color="var(--mantine-color-gray-8)" />
                        }
                        title={
                          <Text size="sm" c="gray.8" fw={700}>
                  ...
                  <Paper p="xl" bg="#0A0B0C" style={{ border: '1px dashed #2A2D31' }}>
                    ...
                    <Text size="xs" c="#E1E1E1" style={{ lineHeight: 1.8 }}>
                      Awaiting final authorization from Principal Micah S. before journal hand-off.
                      Internal technical QC has reached 100% compliance.
                    </Text>
                  </Paper>
                </Stack>
              </Tabs.Panel>
              ...
              <Tabs.Panel value="comms">
                <Box p="xl" bg="#0A0B0C">
                  <Group justify="space-between" align="flex-end">
                    <Box>
                      <Badge variant="outline" color="sage" size="xs" radius={0}>
                        ADMIN_PROXY_ACTIVE
                      </Badge>
                    </Box>
                    <Group gap="xs">
                ...
                <ScrollArea>
                  <Table verticalSpacing="md" horizontalSpacing="xl" highlightOnHover>
                    <Table.Thead bg="#0A0B0C">
                      <Table.Tr>
                        <Table.Th ff="var(--font-body)" style={{ fontSize: '9px' }} c="dimmed">
                          DATE
                        </Table.Th>
                        <Table.Th ff="var(--font-body)" style={{ fontSize: '9px' }} c="dimmed">
                          RECORD_TYPE
                    ...
                    <Table.Tbody>
                      {[
                        {
                          date: '10 Feb 2026',
                          type: 'PUBLISHER_LIAISON',
                          target: 'Routledge Editorial',
                          subject: 'Technical Query: Equation Alignment',
                          status: 'Delivered',
                          sender: 'dr.chen.office@vance.lab',
                        },
                        {
                          date: '05 Feb 2026',
                          type: 'EXECUTIVE_MEMO',
                          target: 'Dr. Emily Chen',
                          subject: 'Methodology Discrepancy Found',
                          status: 'Sent',
                          sender: 'micah@vance.lab',
                        },
                        {
                          date: '01 Feb 2026',
                          type: 'AUTOMATED_PULSE',
                          target: 'Dr. Emily Chen',
                          subject: 'Project Initialized',
                          status: 'Delivered',
                          sender: 'system@vance.lab',
                        },
                      ].map((memo, i) => (
                        <Table.Tr
                          key={i}
                          onClick={() => handleMemoClick(memo)}
                          style={{ cursor: 'pointer', borderBottom: '1px solid #2A2D31' }}
                        >
                          <Table.Td>
                            <Text size="xs" c="dimmed">
                              {memo.date}
                          ...
                          <Table.Td>
                            <Badge variant="dot" color="burnished-gold" size="xs">
                              {memo.type}
                            </Badge>
                          </Table.Td>
                          <Table.Td>
                            <Box>
                              <Text size="sm" fw={700} c="#E1E1E1">
                                {memo.subject}
                              </Text>
                              <Text size="9px" c="dimmed">
                                {memo.target.toUpperCase()}
                              </Text>
                            </Box>
                          </Table.Td>
                          <Table.Td>
                            <Text size="9px" ff="var(--font-body)" c="sage">
              ...
              <Tabs.Panel value="technical" p="xl">
                <SimpleGrid cols={{ base: 1, md: 2 }} spacing={60}>
                    ...
                    <Stack gap="xl" pr="md">
                      <Box style={{ borderLeft: '1px solid #2A2D31', paddingLeft: '20px' }}>
                        <Text size="xs" c="dimmed" mb={4}>
                          SARAH_M // 05 Feb // 14:20
                        </Text>
                        <Text size="xs" c="#E1E1E1" style={{ lineHeight: 1.6 }}>
                          Roadblock: The bibliography file Dr. Chen uploaded uses a non-standard
                          BibTeX schema for the law journals.
                        </Text>
                      </Box>
                      <Box
                        style={{
                          borderLeft: '1px solid var(--mantine-color-burnished-gold-7)',
                          paddingLeft: '20px',
                        }}
                      >
                        <Text size="xs" c="burnished-gold" mb={4}>
                          ARCHITECT // 05 Feb // 14:45
                        </Text>
                        <Text size="xs" c="#E1E1E1" style={{ lineHeight: 1.6 }}>
                          Confirmed. I&apos;ll alert Micah to wait for the next WASM compile before
                          he starts the Executive Review.
                        </Text>
                      </Box>
                    </Stack>
                  </ScrollArea>
                  <Box>
                    <Textarea
                      placeholder="Add technical addendum to project record..."
                      variant="unstyled"
                      p="md"
                      bg="#0A0B0C"
                      styles={{ input: { color: 'white', fontSize: '12px' } }}
                      style={{ border: '1px solid #2A2D31' }}
                      minRows={5}
                    />
                    <Group justify="flex-end" mt="md">
                      <Button size="xs" variant="subtle" color="red" radius={0}>
                        Flag Blocked
                      </Button>
                      <Button size="xs" color="burnished-gold" c="dark-forest" radius={0}>
                        Post to Ledger
                      </Button>
                    </Group>
                  </Box>
              ...
              <Stack gap="md">
                <Box p="md" style={{ border: '1px solid #2A2D31' }}>
                  <Group justify="space-between" mb="xs">
                    ...
                    <Badge size="xs" color="orange" variant="outline" radius={0}>
                      WAITING_ON_THEM
                    </Badge>
                  </Group>
                  <Text size="xs" c="dimmed">
                    Last Status: Proofs sent to publisher via liaison alias on 10 Feb.
                  </Text>
                </Box>
              ...
              <Stack gap="lg">
                <Group justify="space-between">
                  <Box>
                    ...
                    <Text size="lg" ff="var(--font-display)" c="#E1E1E1">
                      ${project.financials.gross}
                    </Text>
                  </Box>
                  <Badge color="sage" variant="filled" radius={0} c="dark-forest">
                    PAID_IN_FULL
                  </Badge>
                </Group>
                ...
                <Group justify="space-between">
                  <Box>
                    <Text size="9px" c="burnished-gold" mb={4} style={{ letterSpacing: '1px' }}>
                      RESEARCHER_PAYOUT (75%)
                    </Text>
                    <Text size="md" ff="var(--font-display)" c="sage">
                      ${project.financials.researcher}
                    </Text>
                  </Box>
                  <Box ta="right">
                    <Text size="9px" c="burnished-gold" mb={4} style={{ letterSpacing: '1px' }}>
                    ...
                    <Text size="md" ff="var(--font-display)" c="parchment">
                      ${project.financials.agency}
                    </Text>
                  </Box>
                </Group>
              </Stack>
