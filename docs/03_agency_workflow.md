# 03: Agency Workflow - The "Clearance Chain" Protocol

This document outlines the internal communication flow. Our goal is to maximize Micah's authority while minimizing his manual workload. We use a "Draft-and-Authorize" model.
...
| :--- | :--- | :--- |
| **`micah@vance.lab`** | Micah [Lastname] | **Executive Clearance.** Deliverables, approvals, and high-level strategy. |
...
## 2. The "Clearance Chain" (Step-by-Step)
...
- **Action:** Set status to `Pending_Clearance`.
...
- He can "One-Click Authorize" or make a quick "Peer-to-Peer" edit to the text.
- **Action:** Micah clicks **[Authorize & Send]**.
...
3.  **The Authorization:** Micah does a bulk authorization of all Friday Pulses in one view.
...
- **Outcome:** The Project Lead (Researcher) is notified of the new information (e.g., "The Publisher sent back revisions"). The researcher drafts a response for Micah to "Authorize."
